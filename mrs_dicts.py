...
def get_mrs_dict():
    ...
    if which_version == "5.2.0" or which_version == "5.3.0" or which_version == "6.0.0":
        return mrs2fs_dict
    else:
        return OrderedDict()
...
def get_wmparc_dict(which_version):
    if which_version == "5.2.0" or which_version == "5.3.0":
        ...
        return fsdict_wmparc
    elif which_version == "6.0.0":
        fsdict_wmparc = OrderedDict([
            ('lhCerebralWhiteMatterVol', 'mrs'),
            ('rhCerebralWhiteMatterVol', 'mrs'),
            ('CerebralWhiteMatterVol', 'mrs'),
            ('MaskVol', 'mrs'),
            ('eTIV', 'mrs'),
            ('wm-lh-bankssts', 'mrs'),
            ('wm-lh-caudalanteriorcingulate', 'mrs'),
